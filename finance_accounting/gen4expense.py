...
def get_table_info_map():
    engine = create_engine("mysql://aspnet_dianping:dp!@OpQW34bn@192.168.7.104:3306/BAFSExpense")
...
def get_project_info():
    author="Yang Yongli"
    project_name = "ba-finance-expense"
    project_base_dir = "/Users/yangyongli/Projects/ba-finance-expense"
    project_package = "com.dianping.ba.finance.expense"
    service_uri_context = "expenseService"
...
if __name__ == "__main__":
    ...
    for table_name, table_info in table_info_map.items():
        if table_name not in ['FS_AuditAuthorizerConfig',]:
            continue
        if table_name == 'FS_AuditAuthorizerConfig':
            table_info["data_name"] = 'AuditAuthorizerConfig'
