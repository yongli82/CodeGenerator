...
if __name__ == "__main__":
    ...
    for table_name, table_info in table_info_map.items():
        if table_name not in ['dpods_leopard_payable_report', 
                              'dpods_leopard_receivable_report',
                              'dpods_leopard_advanced_payment_report', 
                              'dpods_leopard_advanced_receive_report',]:
            continue
        if table_name == 'dpods_leopard_payable_report':
            table_info["data_name"] = 'PayableReport'
        if table_name == 'dpods_leopard_receivable_report':
            table_info["data_name"] = 'ReceivableReport'
        if table_name == 'dpods_leopard_advanced_payment_report':
            table_info["data_name"] = 'AdvancedPaymentReport'
        if table_name == 'dpods_leopard_advanced_receive_report':
            table_info["data_name"] = 'AdvancedReceiveReport'
