...
def get_project_info():
    author="Yang Yongli"
    project_name = "ba-finance-settle"
    project_base_dir = "/Users/yangyongli/Projects/ba-finance-settle"
    project_package = "com.dianping.ba.finance.settle"
    service_uri_context = "baFinanceSettleService"
    ...
    service_project_dir = os.path.join(project_base_dir, "%s-server" % project_name)
