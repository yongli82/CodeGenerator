...
def get_table_info_map():
    ...
    engine = create_engine("mysql://aspnet_dianping:dp!@OpQW34bn@10.66.7.32:3306/DianPingBA_FSExchange")
...
def get_project_info():
    author="Yang Yongli"
    project_name = "ba-finance-exchange"
    project_base_dir = "/Users/yangyongli/Projects/ba-finance-exchange"
    project_package = "com.dianping.ba.finance.exchange"
    service_uri_context = "baFinanceExchangeService"
...
def get_generate_mapping():
    mapping_list = [
        ...
        Mapping(target_file="{{ service_resources_dir }}/config/spring/local/appcontext-server.xml", template_file="service-appcontext-service.xml", action=Mapping.ACTION_INSERT, before="</map>"),
...
if __name__ == "__main__":
    ...
    for table_name, table_info in table_info_map.items():
        if not table_name.startswith("FC_ReceiveRevocationRequest"):
            continue
